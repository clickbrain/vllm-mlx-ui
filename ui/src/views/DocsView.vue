...
.nav-empty { padding: var(--space-3); font-size: 14px; color: var(--tx-muted); }
...
.toc-h3 { padding-left: calc(var(--space-2) + 10px); font-size: 13px; }
...
.markdown-body :deep(h1) { font-size: 24px; font-weight: 700; color: var(--tx-primary); margin: 0 0 var(--space-4); letter-spacing: -.3px; }
.markdown-body :deep(h2) {
  font-size: 18px; font-weight: 700; color: var(--tx-primary);
  margin: var(--space-6) 0 var(--space-3);
  border-bottom: 1px solid var(--bd-subtle); padding-bottom: var(--space-2);
  position: relative;
}
.markdown-body :deep(h3) { font-size: 15.5px; font-weight: 700; color: var(--tx-primary); margin: var(--space-4) 0 var(--space-2); position: relative; }
.markdown-body :deep(h4) { font-size: 14px; font-weight: 700; color: var(--tx-secondary); margin: var(--space-3) 0 var(--space-1); text-transform: uppercase; letter-spacing: .05em; }
...
.markdown-body :deep(code) { font-family: var(--font-mono); font-size: 14px; background: var(--bg-inset); border: 1px solid var(--bd-subtle); border-radius: 3px; padding: 1px 4px; color: var(--si-300); }
...
.markdown-body :deep(pre code) { background: none; border: none; padding: 0; color: var(--tx-secondary); font-size: 14px; }
...
.markdown-body :deep(table) { width: 100%; border-collapse: collapse; margin: 0 0 var(--space-3); font-size: 14.5px; }
.markdown-body :deep(th) { text-align: left; padding: var(--space-2) var(--space-3); font-weight: 700; font-size: 13px; letter-spacing: .04em; text-transform: uppercase; color: var(--tx-muted); border-bottom: 1px solid var(--bd-default); }
